...
const ShotIcon = ({ popupId, selectedIcon, setSelectedIcon, onSelectEmoticon }) => {
    ...
    const emoticons = [
        {
            id: 1,
            popupIconImg: "https://pop4u.s3.amazonaws.com/icons/49/20250218_010745.png",  // P 아이콘
        },
        {
            id: 2,
